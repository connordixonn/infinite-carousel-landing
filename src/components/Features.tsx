...
export const Features = ({ title, subtitle, description }: FeaturesProps) => {
  return (
    <div className="relative py-32 overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[#111] bg-opacity-95">
      ...
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-blue-500/30 to-teal-500/30 rounded-full blur-3xl animate-pulse delay-700"></div>

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header Section */}
        <div className="text-center max-w-3xl mx-auto mb-24 space-y-8">
          <span className="inline-flex items-center px-4 py-1.5 rounded-full text-sm font-medium bg-gradient-to-r from-purple-500/10 to-pink-500/10 text-purple-300 ring-1 ring-purple-400/20">
            {subtitle}
          </span>
          <h2 className="text-6xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-purple-300 to-white">
            {title}
          </h2>
          <p className="text-xl leading-8 text-gray-300/80">
            {description}
          </p>
        </div>
            ...
            >
              ...
              <div className="relative h-full rounded-3xl bg-white/5 backdrop-blur-xl p-8 transition-all duration-500 
                ...
                <h3 className="text-2xl font-bold text-white mb-4 
                  group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-purple-300 
              ...
              {/* Card Glow Effect */}
              <div className="absolute -inset-px bg-gradient-to-r from-purple-500/0 via-purple-500/20 to-pink-500/0 
